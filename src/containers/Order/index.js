            ...
            <div className="orderwrapper__background">
              <div className="d-flex justify-content-between align-items-center orderwrapper__background--orderheading ">
                ...
                <div className="d-flex">
                  ...
                  <div>
                    <select className="orderwrapper__background--selectstatus" onChange={(e)=>setFilterTerm(e.target.value)}>
              ...
              <div>
                {filterTerm==="Status"?orderList.map((curElm, index) => {
                  return (
                    <Row
                ...
                orderList.filter(i=>i.status===filterTerm).map(i=><Row
                  className="productlistwrapper__productlistwrapper--listitem"
                >
                  <Col md={1}>
                    <p>{i.id}</p>
